from PycharmProject.MuGReT-DWA.MuGReT.data.sast.java_depreaction.fun_unit import FunUnit
from typing import List, Dict
from PycharmProject.MuGReT-DWA.MuGReT.util.setting import log
from PycharmProject.MuGReT-DWA.MuGReT.data.graph_builder.code_graph import Code_graph, EDGE_DICT
